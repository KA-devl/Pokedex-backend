...
module.exports = (sequelize, DataTypes) =>{
  return sequelize.define('User', {
    ...
    username : {
      ...
      validate : {
        is: {msg: "match at 6 letters in the front,have at least one letter, match zero to any occurrence of the given numbers range, and cannot have any special characters.", args:/^[a-zA-Z0-9_]{5,}[a-zA-Z]+[0-9]*$/i}, 
